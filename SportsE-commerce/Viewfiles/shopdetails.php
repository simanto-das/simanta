...
$productname = $productprice = $productdescription = $productcatagory  = "";
$productnameErr = $productpriceErr = $productdescriptionErr = $productcatagoryErr =  "";
$product_status = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($counter == 0) {
    ...
    fwrite($user, $productname. "," . $productprice. ",". $productdescription. ",". $productcatagory);
    fwrite($user, "\n");
    fclose($user);
  }
  else {
...
<select name="productcatagory" id="catagory">
  ...
  <option value="online games">online games</option>
    ...
    <br/>
    <div>
      <button type="button" onClick="document.location.href='viewproducts.php'">view</button>
